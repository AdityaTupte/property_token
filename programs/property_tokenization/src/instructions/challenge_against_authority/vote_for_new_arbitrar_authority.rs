...
use crate::{common::{AUTHORITY_CANDIDATE, AUTHORITYVOTERECEIPT, PROPERTY_SYSTEM_SEEDS, ProposalStatus, REMOVEARBITRARAUTHORITYPROPOSAL,}, errors::ErrorCode, functions::voting_for_authority, state::{AuthorityCandidate, AuthorityVoteReceipt,  ElectAuthority, PropertySystemAccount}};


#[derive(Accounts)]
#[instruction(proposal_key:Pubkey,property_system_id:u64,candidate_key:Pubkey)]
pub struct VoteForNewArbitrarAuthority<'info>{
...
pub fn vote_for_new_arbitrar_authority(
