...
use crate::{common::{ARBITRAR_RECEIPT_SEEDS, AuthorityType::{self, ARBITRATOR}, CHALLENGEAUTHORITY, OFFENDERRECEIPT, PROPERTY_SYSTEM_SEEDS, ProposalStatus, REMOVEARBITRARAUTHORITY, REMOVEARBITRARAUTHORITYPROPOSAL,}, errors::ErrorCode, events::{AddedAuthorityForRemoval}, state::{ArbitratorRecepit, ChallengeProposal, ElectAuthority, OffenderReceipt, PropertySystemAccount, Resignation}};
