...
use crate::{common::{AUTHORITY_CANDIDATE, AuthorityType::ARBITRATOR, CANDIDATE_PROFILE, PROPERTY_SYSTEM_SEEDS, ProposalStatus, REMOVEARBITRARAUTHORITYPROPOSAL,}, errors::ErrorCode, events::CandidateSubmitedForProposal, state::{AuthorityCandidate, CandidateProfile,  ElectAuthority, PropertySystemAccount}};
