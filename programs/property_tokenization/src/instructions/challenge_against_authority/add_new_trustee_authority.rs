...
use crate::{common::{AUTHORITY_CANDIDATE, AuthorityType, PROPERTY_SYSTEM_SEEDS, ProposalStatus, RANKCOUNT, RANKINGACCOUNT, REMOVETRUSTEEAUTHORITYPROPOSAL}, errors::ErrorCode, functions::add_new_authority, state::{AuthorityCandidate, ElectAuthority, PropertySystemAccount, RankCounter, RankingAccount,}};


#[derive(Accounts)]

#[instruction(proposal_key:Pubkey, candidate_key:Pubkey,property_system_id:u64,proposal_id:u64,ranking:u8)]
pub struct AddNewTrusteeAuthority<'info>{
    ...
    pub signer: Signer<'info>,
      ...
      #[account(
        ...
        constraint = removal_proposal.authority_type == AuthorityType::TRUSTEE @ ErrorCode::AuthorityNotMatchWithProposal
    )]
...
pub fn add_new_authority_for_remove_proposal(
