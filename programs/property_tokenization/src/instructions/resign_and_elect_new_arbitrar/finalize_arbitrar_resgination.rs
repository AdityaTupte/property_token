...
use crate::{common::{ARBITRAR_RESIGNATION, ELECT_ARBITRAR, PROPERTY_SYSTEM_SEEDS, ProposalStatus}, errors::ErrorCode, state::{ElectAuthority, PropertySystemAccount, Resignation}};


#[derive(Accounts)]

pub struct FinalizeArbitrarResignation<'info>{
...
pub fn finalize_trustee_resignation(
    ctx:Context<FinalizeArbitrarResignation>,
)->Result<()>{
