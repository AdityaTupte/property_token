...
use crate::{common::{AUTHORITY_CANDIDATE, ELECT_ARBITRAR, ProposalStatus, RANKINGACCOUNT}, errors::ErrorCode, state::{AuthorityCandidate, ElectAuthority, RankingAccount}};


#[derive(Accounts)]
#[instruction(proposal_id:u64,property_system:Pubkey,candidate_key1:Pubkey,candidate_key2:Pubkey,ranking1:u8,ranking2:u8)]
pub struct AdjustArbitrarRanking<'info>{
