...
pub struct RTChgProposal{
    ...
    pub threshold_submission_deadline: i64,
...
pub fn initialize(
    ...
    self.proposal_type = ProposalType::REVENUETHRESHOLDCHANGE;
...
impl BaseProposal for RTChgProposal {
...
impl Governance for RTChgProposal {
    ...
    fn deadline(&mut self) -> &mut i64 {
        &mut self.threshold_submission_deadline
    }
}
...
//     fn deadline(&mut self) -> &mut i64 {
//         return &mut self.threshold_submission_deadline;
//     }
