...
#[account()]
pub struct UseReinvestmentProposal{
...
impl UseReinvestmentProposal {
    ...
    pub fn initialize(
        ...
        self.proposal_type = ProposalType::USEREINVESTMENT;

    }             
 }
impl BaseProposal for UseReinvestmentProposal {
...
impl Governance for UseReinvestmentProposal {
